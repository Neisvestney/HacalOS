...
impl ThreadContext {
    pub fn new(thread_id: ThreadId, process_id: ProcessId, instruction_pointer: VirtAddr, stack_pointer: VirtAddr, page_table_phys_frame: PhysFrame) -> Self {
        ...
        cpu_registries_context.stack_frame.cpu_flags = RFlags::from_bits_truncate(0x2) | RFlags::INTERRUPT_FLAG;
